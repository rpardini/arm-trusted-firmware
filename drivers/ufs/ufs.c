...
static void ufs_enum(void)
{
	...
	/* wait for the DEVICE_INIT flag to be reset by the device */
	for (i = 0; i < 1000 && flag == FLAG_DEVICE_INIT; i++)
		flag = ufs_read_flag(FLAG_DEVICE_INIT);
