...
//#define PMIC_RG_OCTL_RTC_32K1V8_0_ADDR	0x36
...
enum {
	...
	PMIC_RG_TOP_CKSEL_CON0_SET = 0x10e,
	PMIC_RG_TOP_CKSEL_CON0_CLR = 0x011C,
	PMIC_RG_TOP_RST_CON0 = 0x013E,
};

/* PMIC SCK Register Definition */
enum {
	PMIC_RG_SCK_TOP_CON0 = 0x050C,
	PMIC_RG_FQMTR_CON0 = 0x388,
	PMIC_RG_FQMTR_CON1 = 0x38a,
	PMIC_RG_FQMTR_CON2 = 0x38c,
