...
#define ICC_SGI0R_EL1_			sys_reg(3, 0, 12,  11, 7)
...
/* for wdt recover from low power scenario to call directly */
...
enum {
	GIC_SMC_EVENT_UPDATE_ISO_STATUS = 1,
	NF_GIC_SMC_EVENT
};
