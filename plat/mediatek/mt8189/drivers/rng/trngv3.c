...
static uint32_t plat_trng_external_swrst(void)
{
	...
	/* reset enable */
	mmio_write_32(TRNG_SWRST_SET_REG, TRNG_SWRST_BIT);
	/* normal */
	mmio_write_32(TRNG_SWRST_CLR_REG, TRNG_SWRST_BIT);
