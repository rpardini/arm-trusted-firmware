...
#define UP_NORMAL_DOMAIN_NS (APU_AO_CTRL + 0x14)
#define UP_PRI_DOMAIN_NS (APU_AO_CTRL + 0x10)
#define UP_NORMAL_DOMAIN (7)
#define UP_PRI_DOMAIN (5)
#define UP_DOMAIN_SHIFT (0)
#define UP_NS_SHIFT (4)

#define USERFW_CTXT (APU_SCTRL_REVISER + 0x100)
#define SECUREFW_CTXT (APU_SCTRL_REVISER + 0x104)
...
#define APU_MBOX(i)(APU_MBOX0 + 0x100 * i)
...
#define APUSYS_RESERVED_MEM_START	(0x62000000)
