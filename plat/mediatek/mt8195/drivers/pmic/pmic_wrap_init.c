...
static signed int _pwrap_init_reg_clock(unsigned int regck_sel)
{
	...
	WRAP_WR32(IOCFG_BM_DRV_CFG1_CLR, 0x3F << 24);
	WRAP_WR32(IOCFG_BM_DRV_CFG2_CLR, 0x3F);
	WRAP_WR32(IOCFG_BM_DRV_CFG1_SET, 0x1b << 24);
	WRAP_WR32(IOCFG_BM_DRV_CFG2_SET, 0x1b);
