...
static const struct apc_infra_peri_dom_16 infra_ao_sys0_devices[] = {
	...
	DAPC_INFRA_AO_SYS0_ATTR("SPM_APB_S",
				...
				FORBIDDEN, NO_PROTECTION, FORBIDDEN10),
			   ...
			   enum devapc_perm_type perm)
{
	...
	mmio_clrsetbits_32(getreg_domain(base, 0, domain_id, apc_register_index),
		     0x3 << (apc_set_index * 2),
	...
	for (d = 0; d < DOM_NUM_INFRA_AO_SYS0; d++)
		for (i = 0; i < reg_max; i++)
			INFO("[DEVAPC] (INFRA_AO_SYS0)D%d_APC_%d: 0x%x\n", d, i,
			       mmio_read_32(getreg_domain(base, SYS0_D0_APC_0, d, i)));
	...
	for (d = 0; d < DOM_NUM_INFRA_AO_SYS1; d++)
		for (i = 0; i < reg_max; i++)
			INFO("[DEVAPC] (INFRA_AO_SYS1)D%d_APC_%d: 0x%x\n", d, i,
			       mmio_read_32(getreg_domain(base, SYS1_D0_APC_0, d, i)));
	...
	for (d = 0; d < DOM_NUM_INFRA_AO_SYS2; d++)
		for (i = 0; i < reg_max; i++)
			INFO("[DEVAPC] (INFRA_AO_SYS2)D%d_APC_%d: 0x%x\n", d, i,
			       mmio_read_32(getreg_domain(base, SYS2_D0_APC_0, d, i)));

	INFO("[DEVAPC] (INFRA_AO)MAS_SEC_0: 0x%x\n",
	       mmio_read_32(getreg(base, MAS_SEC_0)));

	INFO("[DEVAPC] (INFRA_AO 0x%lx)DOM_REMAP_0_0: 0x%x\n",
	       base, mmio_read_32(getreg(base, DOM_REMAP_0_0)));
}
...
static void dump_peri2_ao_apc(uintptr_t base)
{
	...
	for (d = 0; d < DOM_NUM_PERI2_AO_SYS0; d++)
		for (i = 0; i < reg_max; i++)
			INFO("[DEVAPC] (PERI2_AO_SYS0)D%d_APC_%d: 0x%x\n", d, i,
			       mmio_read_32(getreg_domain(base, SYS0_D0_APC_0, d, i)));
}
	...
	for (d = 0; d < DOM_NUM_PERI_PAR_AO_SYS0; d++)
		for (i = 0; i < reg_max; i++)
			INFO("[DEVAPC] (PERI_PAR_AO_SYS0)D%d_APC_%d: 0x%x\n", d,
			       i, mmio_read_32(getreg_domain(base, SYS0_D0_APC_0, d, i)));
...
{
	INFO("[DEVAPC] (DEVAPC_FMEM_AO_BASE 0x%lx)DOM_REMAP_0_0:0x%x\n",
	       base, mmio_read_32(getreg(base, DOM_REMAP_0_0)));
}

static void dump_infra2_ao_apc(uintptr_t base)
{
	INFO("[DEVAPC] (DEVAPC_INFRA2_AO_BASE 0x%lx)DOM_REMAP_0_0:0x%x\n",
	       base, mmio_read_32(getreg(base, DOM_REMAP_0_0)));
}

static void dump_scp_master(uintptr_t base)
{
	INFO("[DEVAPC] SCP:0x%x ADSP:0x%x Lock:0x%x\n",
	       mmio_read_32(getreg(base, SCP_DOM)),
	       mmio_read_32(getreg(base, ADSP_DOM)),
	       mmio_read_32(getreg(base, ONETIME_LOCK)));
}

static void infra_init(uintptr_t base)
{
	/* Side band */
	mmio_clrsetbits_32(getreg(base, MAS_SEC_0), CPU_EB_SEC, SECURE_TRANS << 1);

	/* Master Domain */
	mmio_clrsetbits_32(getreg(base, MAS_DOM_0), SCP_SSPM_DOM, DOMAIN_2 << 16);
	mmio_clrsetbits_32(getreg(base, MAS_DOM_0), CPU_EB_DOM, DOMAIN_2 << 8);
	 ...
	 */
	mmio_clrsetbits_32(getreg(base, DOM_REMAP_2_0), TWO_BIT_DOM_REMAP_0, DOMAIN_0 << 0);
	mmio_clrsetbits_32(getreg(base, DOM_REMAP_2_0), TWO_BIT_DOM_REMAP_1, DOMAIN_1 << 2);
	mmio_clrsetbits_32(getreg(base, DOM_REMAP_2_0), TWO_BIT_DOM_REMAP_2, DOMAIN_1 << 4);
	mmio_clrsetbits_32(getreg(base, DOM_REMAP_2_0), TWO_BIT_DOM_REMAP_3, DOMAIN_3 << 6);
	mmio_clrsetbits_32(getreg(base, DOM_REMAP_2_0), TWO_BIT_DOM_REMAP_4, DOMAIN_1 << 8);
	mmio_clrsetbits_32(getreg(base, DOM_REMAP_2_0), TWO_BIT_DOM_REMAP_5, DOMAIN_1 << 10);
	/*
	 ...
	 */
	mmio_clrsetbits_32(getreg(base, DOM_REMAP_0_0), FOUR_BIT_DOM_REMAP_0, DOMAIN_15 << 0);
	mmio_clrsetbits_32(getreg(base, DOM_REMAP_0_0), FOUR_BIT_DOM_REMAP_1, DOMAIN_15 << 4);
	mmio_clrsetbits_32(getreg(base, DOM_REMAP_0_0), FOUR_BIT_DOM_REMAP_2, DOMAIN_15 << 8);
	mmio_clrsetbits_32(getreg(base, DOM_REMAP_0_0), FOUR_BIT_DOM_REMAP_3, DOMAIN_3  << 12);
	mmio_clrsetbits_32(getreg(base, DOM_REMAP_0_0), FOUR_BIT_DOM_REMAP_4, DOMAIN_4  << 16);
	mmio_clrsetbits_32(getreg(base, DOM_REMAP_0_0), FOUR_BIT_DOM_REMAP_5, DOMAIN_15 << 20);
	mmio_clrsetbits_32(getreg(base, DOM_REMAP_0_0), FOUR_BIT_DOM_REMAP_6, DOMAIN_15 << 24);
	mmio_clrsetbits_32(getreg(base, DOM_REMAP_0_0), FOUR_BIT_DOM_REMAP_7, DOMAIN_15 << 28);
}
...
static void peri_init(uintptr_t base)
{
	...
	/* Master Domain */
	mmio_clrsetbits_32(getreg(base, MAS_DOM_0), SPM_DOM, DOMAIN_2 << 8);
	 ...
	 */
	mmio_clrsetbits_32(getreg(base, DOM_REMAP_0_0), THREE_BIT_DOM_REMAP_0, DOMAIN_0 << 0);
	mmio_clrsetbits_32(getreg(base, DOM_REMAP_0_0), THREE_BIT_DOM_REMAP_1, DOMAIN_1 << 3);
	mmio_clrsetbits_32(getreg(base, DOM_REMAP_0_0), THREE_BIT_DOM_REMAP_2, DOMAIN_2 << 6);
	mmio_clrsetbits_32(getreg(base, DOM_REMAP_0_0), THREE_BIT_DOM_REMAP_3, DOMAIN_3 << 9);
	mmio_clrsetbits_32(getreg(base, DOM_REMAP_0_0), THREE_BIT_DOM_REMAP_4, DOMAIN_4 << 12);
	mmio_clrsetbits_32(getreg(base, DOM_REMAP_0_0), THREE_BIT_DOM_REMAP_5, DOMAIN_5 << 15);
}
...
{
	/* Side band */
	mmio_clrsetbits_32(getreg(base, MAS_SEC_0), SSUSB_SEC, SECURE_TRANS << 21);
	mmio_clrsetbits_32(getreg(base, MAS_SEC_0), SSUSB2_SEC, SECURE_TRANS << 0);
	mmio_clrsetbits_32(getreg(base, MAS_SEC_0), SSUSB_P1_0_SEC, SECURE_TRANS << 1);
	mmio_clrsetbits_32(getreg(base, MAS_SEC_0), SSUSB_P1_1_SEC, SECURE_TRANS << 2);
	mmio_clrsetbits_32(getreg(base, MAS_SEC_0), SSUSB_P2_SEC, SECURE_TRANS << 3);
	mmio_clrsetbits_32(getreg(base, MAS_SEC_0), SSUSB_P3_SEC, SECURE_TRANS << 4);

	/* Master Domain */
	mmio_clrsetbits_32(getreg(base, MAS_DOM_4), PCIE0_DOM, DOMAIN_1 << 8);
	mmio_clrsetbits_32(getreg(base, MAS_DOM_4), PCIE1_DOM, DOMAIN_1 << 16);
...
{
	mmio_write_32(getreg(base, SCP_DOM), DOMAIN_3);
	mmio_write_32(getreg(base, ADSP_DOM), DOMAIN_4);

	/* Let SCP_DOM and ADSP_DOM registers be read-only for security */
	mmio_write_32(getreg(base, ONETIME_LOCK), 0x5);
}
...
void dapc_init(void)
{
	...
	for (i = 0; i < ARRAY_SIZE(devapc_init); i++) {
		...
		/* Init dapc */
		mmio_write_32(getreg(devapc_ao_base, AO_APC_CON), 0x0);
		mmio_write_32(getreg(devapc_ao_base, AO_APC_CON), 0x1);
