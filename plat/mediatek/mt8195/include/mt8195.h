...
#define MSDC1_TOP_BASE      (IO_PHYS + 0x01C70000)
...
#define USB1_SIF_BASE		(IO_PHYS + 0x01E30000) /* PHY: 0x11E4_0000 */
#define USB2_SIF_BASE 		(IO_PHYS + 0x01C40000) /* PHY: 0x11E4_0000 */
#define USB3_SIF_BASE		(IO_PHYS + 0x01C50000) /* PHY: 0x11E4_0000 */
