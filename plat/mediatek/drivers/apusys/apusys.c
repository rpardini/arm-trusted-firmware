 ...
 * 2. apusys_power_init(): init apu pwr register setting
 * 3. apusys_devapc_init(): init apu devapc permission setting
 * 4. apusys_security_ctrl_init(): init soc2apu domain remap setting
 * 5. apusys_rv_mbox_mpu_init(): setup up mbox mpu
 */
