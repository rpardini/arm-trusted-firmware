...
#define SLAVE_FORBID_EXCEPT_D0_NO_PROTECT_D3_D5_D8_SEC_RW(domain) \
	APUSYS_APC_AO_ATTR(domain, \
...
#define SLAVE_FORBID_EXCEPT_D0_D11_NO_PROTECT_D5_D8_SEC_RW(domain) \
	APUSYS_APC_AO_ATTR(domain, \
	NO_PROTECTION, FORBIDDEN,   FORBIDDEN, FORBIDDEN, \
	FORBIDDEN,     SEC_RW_ONLY, FORBIDDEN, FORBIDDEN, \
...
#define SLAVE_FORBID_EXCEPT_D0_D5_D8_SEC_RW(domain) \
	APUSYS_APC_AO_ATTR(domain, \
	SEC_RW_ONLY, FORBIDDEN,   FORBIDDEN, FORBIDDEN, \
	FORBIDDEN,   SEC_RW_ONLY, FORBIDDEN, FORBIDDEN, \
	SEC_RW_ONLY, FORBIDDEN,   FORBIDDEN, FORBIDDEN, \
...
#define SLAVE_FORBID_EXCEPT_D0_SEC_RW_NS_R_D3_SEC_RW_D5_SEC_RW(domain) \
	APUSYS_APC_AO_ATTR(domain, \
	SEC_RW_NS_R, FORBIDDEN,   FORBIDDEN, SEC_RW_ONLY, \
	FORBIDDEN,   SEC_RW_ONLY, FORBIDDEN, FORBIDDEN, \
	FORBIDDEN,   FORBIDDEN,   FORBIDDEN, FORBIDDEN, \
...
#define SLAVE_FORBID_EXCEPT_D0_D5_D7_NO_PROTECT(domain) \
	APUSYS_APC_AO_ATTR(domain, \
	NO_PROTECTION, FORBIDDEN,   FORBIDDEN, FORBIDDEN, \
...
#define SLAVE_FORBID_EXCEPT_D0_D11_SEC_RW_NS_R_D3_D5_SEC_RW(domain) \
	APUSYS_APC_AO_ATTR(domain, \
	SEC_RW_NS_R, FORBIDDEN,   FORBIDDEN, SEC_RW_ONLY, \
	FORBIDDEN,   SEC_RW_ONLY, FORBIDDEN, FORBIDDEN, \
	FORBIDDEN,   FORBIDDEN,   FORBIDDEN, SEC_RW_NS_R, \
	FORBIDDEN,   FORBIDDEN,   FORBIDDEN, FORBIDDEN)
