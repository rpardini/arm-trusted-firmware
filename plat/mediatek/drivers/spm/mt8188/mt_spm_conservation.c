...
static void go_to_spm_after_wfi(int state_id, unsigned int ext_opand, struct spm_lp_scen *spm_lp,
...
int spm_conservation(int state_id, unsigned int ext_opand, struct spm_lp_scen *spm_lp,
		     unsigned int resource_req)
{
